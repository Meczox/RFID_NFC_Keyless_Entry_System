...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  if (PN532_Begin()) {
	  uint8_t msg[] = "PN532 Connected Successfully!\r\n";
	  HAL_UART_Transmit(&huart2, msg, sizeof(msg) - 1, HAL_MAX_DELAY);
  } else {
	  // If it fails, trap the code here forever and continuously transmit the error.
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|COL1_Pin|COL2_Pin|COL3_Pin
                          |COL4_Pin|GPIO_PIN_12|LCD_CRS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5|LCD_CRW_Pin|GPIO_PIN_7|LCD_D4_Pin
  ...
  /*Configure GPIO pins : LD2_Pin COL1_Pin COL2_Pin COL3_Pin
                           COL4_Pin PA12 LCD_CRS_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|COL1_Pin|COL2_Pin|COL3_Pin
                          |COL4_Pin|GPIO_PIN_12|LCD_CRS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PC5 LCD_CRW_Pin PC7 LCD_D4_Pin
                           LCD_D5_Pin LCD_D6_Pin LCD_D7_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_5|LCD_CRW_Pin|GPIO_PIN_7|LCD_D4_Pin
                          |LCD_D5_Pin|LCD_D6_Pin|LCD_D7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
